...
<div class="max-w-6xl mx-auto w-full px-6 py-8">
    <div class="mb-8 flex flex-col md:flex-row md:items-center gap-4 justify-between">
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('admin.courses.modules.questions.create', [$course, $module]) }}" class="inline-flex items-center gap-2 bg-[#3b4d3b] hover:bg-[#2d3b2d] text-white py-2.5 px-4 rounded-xl font-medium transition-colors text-sm">
